...
export function buildSystemPrompt(args: {
  ...
  return [
    ...
    '- Gentilezas de cumprimento como "Tudo bem?", "Como vai?" ou "Tudo certo?" NÃO contam como pergunta: são educação, não uma pergunta a ser respondida. Pode usá-las na saudação junto da sua única pergunta de verdade.',
